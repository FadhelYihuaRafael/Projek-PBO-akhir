                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <% if (errorMsg != null || resep == null) { %>
                                    ...
                                    <a href="<%= contextPath %>/ResepController" class="btn btn-secondary">Kembali</a>
                                <% } else { %>
                                    <h5 class="card-title fw-semibold mb-4">Edit Resep</h5>
                                    
                                    <form method="post" action="<%= contextPath %>/ResepController">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="<%= contextPath %>/ResepController" class="btn btn-secondary">
